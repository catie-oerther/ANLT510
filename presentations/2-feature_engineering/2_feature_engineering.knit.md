...
```{=html}
<style type="text/css">div.toolbar {
  font-size: 14pt;
  color: #FFF;
...
div.slide.titlepage {
  ...
  font-size: 24pt;
  line-height: 150%;
  background: -webkit-linear-gradient(45deg, #7c1818 0%, transparent 70%), -webkit-linear-gradient(135deg, #43b19b 10%, transparent 80%), -webkit-linear-gradient(225deg, #a08fd6 10%, transparent 80%), -webkit-linear-gradient(315deg, #204017 50%, transparent 100%);
  background: -ms-linear-gradient(45deg, #7c1818 0%, transparent 70%), -ms-linear-gradient(135deg, #43b19b 10%, transparent 80%), -ms-linear-gradient(225deg, #a08fd6 10%, transparent 80%), -ms-linear-gradient(315deg, #204017 50%, transparent 100%);
  background: linear-gradient(45deg, #7c1818 0%, transparent 70%), linear-gradient(135deg, #43b19b 10%, transparent 80%), linear-gradient(225deg, #a08fd6 10%, transparent 80%), linear-gradient(315deg, #204017 50%, transparent 100%);
  background-size: 100%;
  color: #FFF;
}
...
ul ul {
  ...
  margin: 0.25em 1.0em 0.25em 1.0em;
}
ul ul ul {
...
ul {
  margin: 0.5em 1.5em 0.5em 1.75em;
  padding: 0 0 0 0;
  font-weight: normal;
  color: #2C3E50;
  text-shadow: none;
...
/* CSS Rules for tutor output */
.tutor-exercise-input .btn-xs {
  font-size: 22px;
  width: auto;
}
.tutor-panel-heading {
...
```{=html}
<style type="text/css">div.slide.titlepage {
  text-align: left;
  font-weight: normal;
  font-size: 24pt;
  line-height: 150%;
  background: url(http://logosandbrands.directory/wp-content/themes/directorypress/thumbs/Wittenberg-University-logo.jpg);
...
<img src="2_feature_engineering_files/figure-slidy/skewed-residuals-1.png" width="576" style="display: block; margin: auto;" />
...
<img src="2_feature_engineering_files/figure-slidy/distribution-comparison-1.png" width="1152" style="display: block; margin: auto;" />
...
<img src="2_feature_engineering_files/figure-slidy/missing-distribution-plot-1.png" width="960" style="display: block; margin: auto;" />


<img src="2_feature_engineering_files/figure-slidy/missing-distribution-plot2-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="2_feature_engineering_files/figure-slidy/imputation-examples-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="C:/Users/Aubur/github/witt-analytics/anlt510_resources/resources/images/accuracy-comparison-1.png" width="960" style="display: block; margin: auto;" />

- increase computation time

<img src="C:/Users/Aubur/github/witt-analytics/anlt510_resources/resources/images/impact-on-time-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="2_feature_engineering_files/figure-slidy/standardizing-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="2_feature_engineering_files/figure-slidy/pca-1.png" width="960" style="display: block; margin: auto;" />
...
<img src="C:/Users/Aubur/github/witt-analytics/anlt510_resources/resources/images/data-leakage.png" width="80%" height="80%" style="display: block; margin: auto;" />
...
<div id="container1">
<img src="https://raw.githubusercontent.com/rstudio/hex-stickers/master/PNG/recipes.png" width="35%" style="display: block; margin: auto 0 auto auto;" />
</div>
</div>
...
<div id="container1">
<img src="https://media1.tenor.com/images/6358cb41e076a3c517e5a9988b1dc888/tenor.gif?itemid=5711499" width="50%" height="50%" style="display: block; margin: auto 0 auto auto;" />
</div>
</div>
...
<img src="2_feature_engineering_files/figure-slidy/example-blue-print-application7-1.png" width="960" style="display: block; margin: auto;" />
