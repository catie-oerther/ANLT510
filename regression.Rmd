...
- It's also important to understand where linear regression fits in with other models
...
- In words, this expression states that:
    ...
    + Builing a regression model that includes these inputs may help us understand the relationship between $X$ and $Y$
    + The $\beta$ terms how strength of the relationship between $X$ and $Y$
...
- It's important that you recognize that this model expression has three parts (1 and 2 are easy to see - 3 is not)
